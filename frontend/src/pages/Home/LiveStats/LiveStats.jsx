...
const LiveStats = () => {
  ...
  const {
    data: stats = { users: 0, totalCoins: 0 },
    isLoading,
    error,
  } = useQuery({
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-blue-100 to-pink-100 dark:from-gray-900 dark:to-gray-800 mt-12 rounded-2xl transition-colors duration-300">
      <h2 className="text-3xl font-bold text-center mb-8 ">
        📈<span className="text-primary-gradient dark:text-indigo-300"></span> Platform Stats
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto px-6 text-center">
        <motion.div
