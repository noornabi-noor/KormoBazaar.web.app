...
//                     className=" text-4xl md:text-6xl font-extrabold bg-gradient-to-r from-sky-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent drop-shadow-lg"
//                   >
//                     {slide.title}
//                   </motion.h1>
...
//                     className="mt-4 text-lg md:text-xl font-medium max-w-2xl drop-shadow-md"
//                   >
//                     {slide.subtitle}
//                   </motion.p>
